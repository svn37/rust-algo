...
mod tests {
    ...
    fn hashtable_single_remove() {
        let mut m: HashTable<_, u64> = HashTable::new();
    ...
    // hashtabletps://github.com/rust-lang/rust/blob/1facd4a77b181ad44b9c9a64f0fd21b6d5180458/library/std/src/collections/hash/map.rs#L3024
    #[test]
    ...
    // hashtabletps://github.com/rust-lang/rust/blob/1facd4a77b181ad44b9c9a64f0fd21b6d5180458/library/std/src/collections/hash/map.rs#L3250test
    #[test]
    fn hashtable_clone() {
        let mut m = HashTable::new();
        assert_eq!(m.len(), 0);
    ...
    // hashtabletps://github.com/rust-lang/rust/blob/1facd4a77b181ad44b9c9a64f0fd21b6d5180458/library/std/src/collections/hash/map.rs#L3250
    #[test]
    fn hashtable_eq() {
        let mut m1 = HashTable::new();
        m1.insert(1, 2);
        m1.insert(2, 3);
        m1.insert(3, 4);

        let mut m2 = HashTable::new();
        m2.insert(1, 2);
        m2.insert(2, 3);
    ...
    // hashtabletps://github.com/rust-lang/rust/blob/1facd4a77b181ad44b9c9a64f0fd21b6d5180458/library/std/src/collections/hash/map.rs#L3268
    #[test]
    fn hashtable_show() {
